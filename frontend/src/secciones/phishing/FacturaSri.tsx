...
const SIGNALS: Signal[] = [
  ...
  },
  {
    ...
    targetId: "externo",
    texto:
      "Tu propio correo lo marcó como <b>externo</b>. Una institución que llega así merece comprobarse aparte.",
  },
  {
    id: "plazo",
    pantalla: "n1",
...
const CONTEXT: Context = {
  antes: (
    <>
      ...
      <strong>SRI</strong> no te sorprende.
    </>
  ),
  ahora: (
    <>
  ...
  return (
    <>
      <div className={styles.page}>
        ...
        <SiteNotice>
          El comprobante quedará habilitado en un plazo máximo de 24 horas tras
          la validación. No comparta sus credenciales con terceros.
        </SiteNotice>
  ...
  return (
    <div className="grid gap-3">
      ...
      <Instructions
        ...
        pista={
          <p>
            Tienes tres caminos posibles: hacer lo que el correo te pide, abrir
            lo que trae adjunto, o dejar el correo de lado y usar el canal
            oficial para comprobar el plazo desde los marcadores. Cuál de los
            tres es el acertado es justamente lo que decides tú.
          </p>
        }
      >
        ...
        {onRealPortal && (
          <p className="rounded-md border border-hairline-strong bg-canvas-soft px-3 py-2 text-base leading-relaxed text-body">
            ...
            , así que el correo mentía. Cierra la pestaña cuando termines de
            comprobarlo.
          </p>
        )}
        ...
        {onPortal && (
          <p className="rounded-md border border-hairline-strong bg-canvas-soft px-3 py-2 text-base leading-relaxed text-body">
            ...
            así para no pedirte datos verdaderos (ese RUC no es el de nadie),
            pero enviarlo cuenta como entregarlos.
          </p>
        )}
    ...
    <>
      <div className={styles.page}>
        ...
        <div className={styles.portalAviso}>
          <ShieldCheck
            aria-hidden
            className={styles.portalAvisoIcono}
            strokeWidth={1.75}
          />
          <span>
            Tu RUC no tiene comprobantes pendientes ni multas registradas.
            Tampoco hay ninguna notificación abierta a tu nombre.
          </span>
        </div>
