...
const CONTEXTO = (
  <>
    <p>Compraste unos audífonos inalámbricos hace unos días y sí estás esperando el envío.</p>
    <p>
      El correo que te llega trae tu nombre completo y parte de tu número de cédula — datos que vos
      nunca les diste a un courier.
    </p>
  </>
)
