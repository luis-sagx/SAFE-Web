...
const PAGINA: ScreenView = {
  ...
  subtitle:
    "Confirma tu contraseña actual para mantenerla vigente 90 días más.",
  fields: [
    {
...
const STORY: Story<ScreenNode> = {
  ...
  n1: {
    ...
    choices: [
      ...
      {
        label:
          "Escribir a Soporte TI usando el contacto del directorio interno para confirmar.",
        goto: "e_confirma",
      },
      {
        label: "Reenviar el correo a mis compañeros para avisarles del plazo.",
        goto: "n1b",
      },
    ],
  },
  n1b: {
    ...
    choices: [
      {
        label: "Ahora sí, entrar al enlace y renovar mi contraseña.",
        goto: "n2",
      },
      {
        label: "Revisar el dominio del remitente antes de hacer nada más.",
        goto: "e_remitente",
      },
    ],
  },
...
const RESUMEN =
  'Un correo de "Soporte TI" avisa que tu contraseña caduca hoy a las 18:00.';

const CONTEXTO = (
  <>
    <p>
      Trabajas en <strong>Corporación Andes</strong>. Tu correo institucional
      termina en <strong>@andes.com.ec</strong> y sí has recibido antes avisos
      de Sistemas por cambios de contraseña.
    </p>
    <p>
      Son las cuatro de la tarde, estás cerrando pendientes, y llega un mensaje
      con un plazo que vence en dos horas.
    </p>
  </>
);
