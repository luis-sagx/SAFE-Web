  ...
  datos: [
    {
      etiqueta: "Hoy · 09:11",
      valor:
        "Transferencia recibida $180,00 · de Gabriela Ponce Salazar · ACREDITADA",
      senal: "acreditada",
    },
    {
      etiqueta: "Ayer · 17:40",
...
const ENTREGA: ScreenView = {
  ...
  respuestas: [
    ...
    {
      texto: "Mejor pase por mi casa a las 4, que la lavadora pesa.",
      goto: "e_entrega",
      label: "Cerró la venta y quedó en entregar en su casa",
    },
  ],
};
...
export const STORY: Story<ScreenNode> = {
  ...
  e_deja: {
    ...
    outcome:
      "Saliste de la conversación y no volviste. El dinero estaba acreditado en tu cuenta, a nombre de la compradora, y ella no te había pedido nada raro ni te había metido prisa: se quedó esperando una respuesta que nunca llegó y a los dos días pidió que le devolvieras su plata. Desconfiar de todo también cuesta. Lo que hay que aprender no es a no vender, es a mirar el saldo disponible antes de entregar.",
    score: 20,
  },
};
...
const CONTEXTO: Contexto = {
  antes: (
    <>
      Pusiste en venta tu <strong>lavadora en $180</strong> por una página de
      compraventa, y una compradora quedó en pagarte por transferencia.
    </>
  ),
  ahora: (
    <>
      <strong>Esta mañana</strong> te escribe diciendo que ya hizo el pago y que
      pasa a recogerla cuando a ti te quede bien.
    </>
  ),
  detalle:
    "La lavadora sigue en tu casa y tienes la app del banco en el teléfono.",
};
    ...
    <StoryEscenario
      ...
      instruccion={
        <p className="text-lg leading-relaxed text-body">
          Actúa sobre el teléfono como lo harías con el tuyo: contéstale a la
          compradora y usa <strong>cualquier app de abajo</strong>. No todo lo
          que llega es una trampa.
        </p>
      }
      pista={
        <p>
          Puedes seguirle la conversación, abrir tu banco a mirar la cuenta, ver
          el perfil de la compradora en tu anuncio o cerrar el trato. Comprueba
          lo mismo que comprobarías si sospecharas.
        </p>
      }
    />
  );
