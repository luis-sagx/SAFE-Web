...
const BASE: ScreenView = {
  ...
  decir: [
    ...
    {
      texto: '¿De qué declaración me habla? Yo no he reclamado ninguna devolución.',
      goto: 'n3b',
...
const DIO_CEDULA: ScreenView = {
  ...
  decir: [
    { texto: `Sí, esa es. El código es ${CODIGO}.`, goto: 'e_codigo', label: 'Dictó el código que le llegó del banco' },
  ],
...
const SIN_CEDULA: ScreenView = {
  ...
  dialogo: [
    ...
    {
      texto:
        'Es automática, señora, sale del cruce de sus gastos deducibles. No tiene que reclamar nada, solo confirmarme la cédula y la cuenta donde le depositamos.',
      senal: 'insisten',
    },
    ...CIERRE,
  ],
...
const PORTAL: ScreenView = {
  ...
  datos: [
    { etiqueta: 'Devoluciones a tu favor', valor: 'Ninguna', senal: 'sin-devolucion' },
    { etiqueta: 'Trámites en curso', valor: 'Ninguno' },
    { etiqueta: 'Última declaración', valor: 'Presentada y sin saldo pendiente' },
  ],
  aviso:
...
export const STORY: Story<ScreenNode> = {
  ...
  e_codigo: {
    ...
    outcome: `No había ninguna devolución. El código ${CODIGO} no liberaba ningún depósito: era el que tu banco envía para autorizar una transferencia, y con él sacaron el dinero de tu cuenta mientras seguías al teléfono. Ese código nunca sirve para recibir, solo para pagar.`,
  },
  e_portal: {
    kind: 'good',
    view: PORTAL,
...
const RESUMEN = 'Una llamada dice que el SRI tiene una devolución de impuestos a tu favor.'
...
const CONTEXTO: Contexto = {
  ...
  ahora: (
    <>
      <strong>Una mañana entre semana</strong> te llama un número desconocido diciendo que es del
      SRI y que tienes dinero a tu favor.
    </>
  ),
...
function DevolucionSri() {
  return (
    <StoryEscenario
      ...
      pista={
        <p>
          Puedes no contestar, escuchar y responder, colgar en cualquier momento o dejar la llamada
          esperando y comprobar por tu cuenta si esa devolución existe. Fíjate en qué te piden y en
          qué momento.
        </p>
      }
    />
