...
const ESCENA: ScreenView = {
  ...
  datos: [
    ...
    },
    {
      ...
      valor: 'Nóminas, contatos, datos bancarios',
      senal: 'peligro',
    },
    {
      etiqueta: 'Acceso',
...
const CONTEXTO: Contexto = {
  ...
  ahora: (
    <>
      ...
      salarios de la nómina, y hasta extractos bancarios de un tercero. Están visibles en la papelera pública. La persona
      de limpieza llega en una hora.
    </>
  ),
}
