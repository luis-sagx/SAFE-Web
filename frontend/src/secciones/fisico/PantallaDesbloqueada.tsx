...
const CONTEXTO: Contexto = {
  ...
  ahora: (
    <>
      <strong>Afternoon coffee break.</strong> Tu compañero se levanta de su escritorio diciendo "me voy un momentito".
      Cuando se va, ves que su pantalla quedó completamente desbloqueada con tres cosas abiertas: el sistema de nómina (donde
      están todos los salarios), su correo con proyectos confidenciales, y la app de banca para hacer transferencias desde el
      área contable.
    </>
  ),
}
