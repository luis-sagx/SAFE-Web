...
const SCENE: ScreenView = { kind: 'escena', src: '/escenarios/fisico/internet-cafe.webp', alt: 'Código QR de WiFi en la pared de un café', zonas: [{ id: 'qr-cafe', x: '52%', y: '42%', ancho: '18%', alto: '28%' }] }
