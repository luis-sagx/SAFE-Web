...
const SIGNALS: Signal[] = [{ id: 'qr', targetId: 'qr-cafe', texto: '<b>El QR no revela a dónde te llevará</b>. Confirma la red con el personal antes de escanearlo.' }]
export const CONTEXT: Context = { antes: 'Los QR también pueden esconder enlaces maliciosos: el código no permite juzgar su destino a simple vista.', ahora: <><strong>Ahora</strong> necesitas conectarte en un café y ves un QR que ofrece WiFi gratis.</> }
