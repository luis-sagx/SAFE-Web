...
export const VOCES: Record<string, string> = {
  ...
  "El sistema la eligió al azar, no se preocupe. Solo tiene que cubrir el impuesto de entrega: cuarenta dólares, y hoy mismo le llevamos la cocina a su casa.": "/voz/524a1c6ae287.mp3",
  ...
  "Es automática, señora, sale del cruce de sus gastos deducibles. No tiene que reclamar nada, solo confirmarme la cédula y la cuenta donde le depositamos.": "/voz/021a50003762.mp3",
  "Es el impuesto de entrega, señora, todos los ganadores lo pagan. Deposite a la cuenta de mi compañera María: veintidós, cero cero setenta y cuatro, once ochenta y ocho.": "/voz/29b09342b6d8.mp3",
  ...
  "Es solo para validar que hablo con el titular, señora, es el protocolo. Si prefiere lo dejamos, aunque el beneficio de la comisión se registra hoy y mañana ya no le puedo ayudar.": "/voz/d90f18365e1a.mp3",
  "Es una pregunta muy sensata, señora. Puede comprobar que este número aparece en la página del banco. Vamos a anular el cargo ahora mismo desde aquí.": "/voz/59a01509b54f.mp3",
  ...
  "Lo vemos desde la central, señora, porque su router pasa por nuestra red. Nosotros no entramos a nada suyo, solo miramos el tráfico.": "/voz/b554646c56c3.mp3",
  "No, el premio es gratis, señora. Lo que se cobra es el impuesto de entrega, que lo pone la transportadora, no nosotros.": "/voz/936321b9e909.mp3",
  "No, señora, el sistema no libera el despacho sin el pago del impuesto. Es una norma de la promoción, yo no la puedo saltar.": "/voz/1d5400a9fb08.mp3",
  ...
  "Y no cuelgue, señora: si corta la llamada el cargo se ejecuta y ya no lo podemos detener.": "/voz/d76c995fc57e.mp3",
