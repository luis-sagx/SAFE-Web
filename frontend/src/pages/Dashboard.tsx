...
function Dashboard() {
  ...
  const complete = global.modulos > 0 && global.modulosAprobados === global.modulos
  ...
  return (
    <div className="min-h-screen bg-canvas">
      ...
      <main className="mx-auto max-w-6xl px-6 py-12">
        <h1 className="font-display text-5xl uppercase leading-[0.95] tracking-[0.01em] text-ink sm:text-6xl">
          Hola, {displayName}
        </h1>
              ...
              {complete ? (
                <>
                  <p className="text-base leading-relaxed text-body">
                    Terminaste los {global.modulos} módulos. ¿Qué te pareció el entrenamiento?{' '}
                    <a
        ...
        >
            ...
            >
              ...
              <div className="flex flex-wrap items-baseline justify-between gap-x-6 gap-y-2">
                ...
                <p className="font-mono text-base uppercase tracking-[0.12em] text-muted">
                  <span className="text-xl text-ink tabular-nums">{global.modulosAprobados}</span>
                  ...
                  <span className="text-ink tabular-nums">{global.aprobados}</span>
          ...
          <ul>
            {SECTIONS.map((section, index) => {
              ...
              const content = (
                <>
                  ...
                  <div className="shrink-0 sm:w-56">
                    ...
                    {progress?.aprobado && (
                      <Sello tono="border-success-ink text-success-ink">Aprobado</Sello>
                    )}
                    ...
                    {available && (
                      <p className="mt-3 font-mono text-sm uppercase tracking-[0.14em] text-muted">
                        {progress ? (
                          <>
                            <span className="text-ink tabular-nums">{progress.aprobados}</span>
                    ...
                    {available && (
                      <span
                        aria-hidden
                        className="mt-3 inline-flex items-center gap-1.5 font-mono text-sm uppercase tracking-[0.14em] text-link transition group-hover:translate-x-0.5"
                      >
                        Abrir módulo
              ...
              const rowClassName =
                'flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:gap-8'
