...
function ScenarioLayout({
  ...
  if (phase === "briefing") {
    return (
      <div className={`relative min-h-dvh overflow-hidden bg-canvas ${TRAMA_FONDO}`}>
  ...
  return (
    ...
    <div className={`relative flex min-h-dvh flex-col bg-canvas-soft sm:h-dvh sm:overflow-hidden ${TRAMA_FONDO}`}>
